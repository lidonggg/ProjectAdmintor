package com.admin.projectadmintor.baidu;
...
import com.admin.projectadmintor.homePage.BaseActivity;
...
//            } else
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baidu_route_plan);
        init();
    }
...
//        mLocationClient.registerLocationListener(myListener);    //注册监听函数
    ...
    public void onGetWalkingRouteResult(WalkingRouteResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(BaiduRoutePlanActivity.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
        }
